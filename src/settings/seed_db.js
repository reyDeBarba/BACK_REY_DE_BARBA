...
const seedDB = async () => {
  ...
  await User.create(
    {
      email: 'nahuel_administrador@gmail.com '.trimEnd(),
      firstName: 'Nahuel',
      ...
      admin: true,
      photoURL:
        'https://firebasestorage.googleapis.com/v0/b/rey-de-barba-3.appspot.com/o/Avatars%2F6340ecf7f9077a047c161627?alt=media&token=d2692678-2890-47db-be2d-7b058cce6061',
    },
    {
  ...
  const barberId = await User.findOne({
    barber: true,
    email: 'ignacio@gmail.com',
  });
  ...
  await Posts.create(
    ...
    },
    {
      ...
      user: barberId._id,
      services: serviceId._id,
      likes: ['63363fe708f2a492302c7d6e'],
      views: [],
    },
  );
  await Turns.create(
